...
namespace WebApplication_AspNetCoreMVC_Bilheteira.Controllers
{
    public class LocaisController : Controller
    {
        ...
        public LocaisController(WebApplication_BilheteiraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Morada,CodPostal,Telefone")] Local local)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Morada,CodPostal,Telefone")] Local local)
        {
            if (id != local.Id)
            {
                return NotFound();
